...
const powerCard02 = () => {
    const ctx = document.getElementById("power-card-02");
    if (!ctx) return;
    ...
    fetch("/json-power2")
        ...
        .then((result) => {
            ...
            const chartValue = document.getElementById("power-card-02-value");
            const chartDeviation = document.getElementById(
                "power-card-02-deviation"
            );
