...
const temperatureCard07 = () => {
    const ctx = document.getElementById("temperature-card-07");
    if (!ctx) return;
    ...
    fetch("/json-temperature7")
        ...
        .then((result) => {
            ...
            const chartValue = document.getElementById(
                "temperature-card-07-value"
            );
            const chartDeviation = document.getElementById(
                "temperature-card-07-deviation"
            );
...
export default temperatureCard07;
