...
const powerCard01 = () => {
    const ctx = document.getElementById("power-card-01");
    if (!ctx) return;
    ...
    fetch("/json-power1")
        ...
        .then((result) => {
            ...
            const chartValue = document.getElementById("power-card-01-value");
            const chartDeviation = document.getElementById(
                "power-card-01-deviation"
            );
