...
const powerCard03 = () => {
    const ctx = document.getElementById("power-card-03");
    if (!ctx) return;
    ...
    fetch("/json-power3")
        ...
        .then((result) => {
            ...
            const chartValue = document.getElementById("power-card-03-value");
            const chartDeviation = document.getElementById(
                "power-card-03-deviation"
            );
