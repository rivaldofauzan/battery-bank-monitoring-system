...
const resistanceCard01 = () => {
    const ctx = document.getElementById("resistance-card-01");
    if (!ctx) return;
    ...
    fetch("/json-resistance1")
        ...
        .then((result) => {
            ...
            const chartValue = document.getElementById(
                "resistance-card-01-value"
            );
            const chartDeviation = document.getElementById(
                "resistance-card-01-deviation"
            );
...
export default resistanceCard01;
