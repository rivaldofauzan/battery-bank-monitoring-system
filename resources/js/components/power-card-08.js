...
const powerCard08 = () => {
    const ctx = document.getElementById("power-card-08");
    if (!ctx) return;
    ...
    fetch("/json-power8")
        ...
        .then((result) => {
            ...
            const chartValue = document.getElementById("power-card-08-value");
            const chartDeviation = document.getElementById(
                "power-card-08-deviation"
            );
