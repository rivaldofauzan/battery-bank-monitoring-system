...
const temperatureCard02 = () => {
    const ctx = document.getElementById("temperature-card-02");
    if (!ctx) return;
    ...
    fetch("/json-temperature2")
        ...
        .then((result) => {
            ...
            const chartValue = document.getElementById(
                "temperature-card-02-value"
            );
            const chartDeviation = document.getElementById(
                "temperature-card-02-deviation"
            );
...
export default temperatureCard02;
