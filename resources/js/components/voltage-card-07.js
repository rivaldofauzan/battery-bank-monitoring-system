...
const voltageCard07 = () => {
    const ctx = document.getElementById("voltage-card-07");
    if (!ctx) return;
    ...
    fetch("/json-voltage7")
        ...
        .then((result) => {
            ...
            const chartValue = document.getElementById("voltage-card-07-value");
            const chartDeviation = document.getElementById(
                "voltage-card-07-deviation"
            );
