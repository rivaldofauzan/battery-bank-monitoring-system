...
const humidityCard01 = () => {
    const ctx = document.getElementById("humidity-card-01");
    if (!ctx) return;
    ...
    fetch("/json-humidity1")
        ...
        .then((result) => {
            ...
            const chartValue = document.getElementById(
                "humidity-card-01-value"
            );
            const chartDeviation = document.getElementById(
                "humidity-card-01-deviation"
            );
