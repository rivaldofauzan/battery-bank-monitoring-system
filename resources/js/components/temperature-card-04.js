...
const temperatureCard04 = () => {
    const ctx = document.getElementById("temperature-card-04");
    if (!ctx) return;
    ...
    fetch("/json-temperature4")
        ...
        .then((result) => {
            ...
            const chartValue = document.getElementById(
                "temperature-card-04-value"
            );
            const chartDeviation = document.getElementById(
                "temperature-card-04-deviation"
            );
...
export default temperatureCard04;
