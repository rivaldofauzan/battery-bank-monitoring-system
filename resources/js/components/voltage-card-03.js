...
const voltageCard03 = () => {
    const ctx = document.getElementById("voltage-card-03");
    if (!ctx) return;
    ...
    fetch("/json-voltage3")
        ...
        .then((result) => {
            ...
            const chartValue = document.getElementById("voltage-card-03-value");
            const chartDeviation = document.getElementById(
                "voltage-card-03-deviation"
            );
