...
const temperatureCard03 = () => {
    const ctx = document.getElementById("temperature-card-03");
    if (!ctx) return;
    ...
    fetch("/json-temperature3")
        ...
        .then((result) => {
            ...
            const chartValue = document.getElementById(
                "temperature-card-03-value"
            );
            const chartDeviation = document.getElementById(
                "temperature-card-03-deviation"
            );
...
export default temperatureCard03;
