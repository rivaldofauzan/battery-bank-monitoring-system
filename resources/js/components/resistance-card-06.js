...
const resistanceCard06 = () => {
    const ctx = document.getElementById("resistance-card-06");
    if (!ctx) return;
    ...
    fetch("/json-resistance6")
        ...
        .then((result) => {
            ...
            const chartValue = document.getElementById(
                "resistance-card-06-value"
            );
            const chartDeviation = document.getElementById(
                "resistance-card-06-deviation"
            );
...
export default resistanceCard06;
