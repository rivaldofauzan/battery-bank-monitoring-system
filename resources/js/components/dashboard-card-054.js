...
const dashboardCard054 = () => {
    const ctx = document.getElementById("dashboard-card-054");
    if (!ctx) return;
    ...
    fetch("/public/json-resistance-data")
        ...
        .then((result) => {
            ...
            const data = result.map((item) => item.average_resistance);
            ...
            const chartValue = document.getElementById(
                "dashboard-card-054-value"
            );
            const chartDeviation = document.getElementById(
                "dashboard-card-054-deviation"
            );
            ...
            const reload = () => {
                ...
                if (increment + range - 1 < result.data.length) {
                    adddata(
                        result.data[increment + range - 1].average_resistance,
                        result.data[increment + range - 2].average_resistance
                    );
                } else {
                    increment = 0;
                    range = data.length;
                    adddata(
                        result.data[increment + range - 1].average_resistance,
                        result.data[result.data.length - 1].average_resistance
                    );
                }
...
export default dashboardCard054;
