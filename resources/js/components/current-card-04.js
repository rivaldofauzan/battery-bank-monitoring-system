...
const currentCard04 = () => {
    const ctx = document.getElementById("current-card-04");
    if (!ctx) return;
    ...
    fetch("/json-current4")
        ...
        .then((result) => {
            ...
            const chartValue = document.getElementById("current-card-04-value");
            const chartDeviation = document.getElementById(
                "current-card-04-deviation"
            );
