...
const temperatureCard01 = () => {
    const ctx = document.getElementById("temperature-card-01");
    if (!ctx) return;
    ...
    fetch("/json-temperature1")
        ...
        .then((result) => {
            ...
            const chartValue = document.getElementById(
                "temperature-card-01-value"
            );
            const chartDeviation = document.getElementById(
                "temperature-card-01-deviation"
            );
...
export default temperatureCard01;
