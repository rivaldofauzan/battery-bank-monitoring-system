...
const resistanceCard07 = () => {
    const ctx = document.getElementById("resistance-card-07");
    if (!ctx) return;
    ...
    fetch("/json-resistance7")
        ...
        .then((result) => {
            ...
            const chartValue = document.getElementById(
                "resistance-card-07-value"
            );
            const chartDeviation = document.getElementById(
                "resistance-card-07-deviation"
            );
...
export default resistanceCard07;
