...
const voltageCard02 = () => {
    const ctx = document.getElementById("voltage-card-02");
    if (!ctx) return;
    ...
    fetch("/json-voltage2")
        ...
        .then((result) => {
            ...
            const chartValue = document.getElementById("voltage-card-02-value");
            const chartDeviation = document.getElementById(
                "voltage-card-02-deviation"
            );
