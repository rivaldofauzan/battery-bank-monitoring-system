...
const currentCard05 = () => {
    const ctx = document.getElementById("current-card-05");
    if (!ctx) return;
    ...
    fetch("/json-current5")
        ...
        .then((result) => {
            ...
            const chartValue = document.getElementById("current-card-05-value");
            const chartDeviation = document.getElementById(
                "current-card-05-deviation"
            );
