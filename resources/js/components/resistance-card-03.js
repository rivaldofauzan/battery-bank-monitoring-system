...
const resistanceCard03 = () => {
    const ctx = document.getElementById("resistance-card-03");
    if (!ctx) return;
    ...
    fetch("/json-resistance3")
        ...
        .then((result) => {
            ...
            const chartValue = document.getElementById(
                "resistance-card-03-value"
            );
            const chartDeviation = document.getElementById(
                "resistance-card-03-deviation"
            );
...
export default resistanceCard03;
