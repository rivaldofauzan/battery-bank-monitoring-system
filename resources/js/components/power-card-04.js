...
const powerCard04 = () => {
    const ctx = document.getElementById("power-card-04");
    if (!ctx) return;
    ...
    fetch("/json-power4")
        ...
        .then((result) => {
            ...
            const chartValue = document.getElementById("power-card-04-value");
            const chartDeviation = document.getElementById(
                "power-card-04-deviation"
            );
