...
const resistanceCard05 = () => {
    const ctx = document.getElementById("resistance-card-05");
    if (!ctx) return;
    ...
    fetch("/json-resistance5")
        ...
        .then((result) => {
            ...
            const chartValue = document.getElementById(
                "resistance-card-05-value"
            );
            const chartDeviation = document.getElementById(
                "resistance-card-05-deviation"
            );
...
export default resistanceCard05;
