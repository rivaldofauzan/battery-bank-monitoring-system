...
const humidityCard07 = () => {
    const ctx = document.getElementById("humidity-card-07");
    if (!ctx) return;
    ...
    fetch("/json-humidity7")
        ...
        .then((result) => {
            ...
            const chartValue = document.getElementById(
                "humidity-card-07-value"
            );
            const chartDeviation = document.getElementById(
                "humidity-card-07-deviation"
            );
