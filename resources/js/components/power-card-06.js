...
const powerCard06 = () => {
    const ctx = document.getElementById("power-card-06");
    if (!ctx) return;
    ...
    fetch("/json-power6")
        ...
        .then((result) => {
            ...
            const chartValue = document.getElementById("power-card-06-value");
            const chartDeviation = document.getElementById(
                "power-card-06-deviation"
            );
