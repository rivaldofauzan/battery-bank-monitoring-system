...
const powerCard07 = () => {
    const ctx = document.getElementById("power-card-07");
    if (!ctx) return;
    ...
    fetch("/json-power7")
        ...
        .then((result) => {
            ...
            const chartValue = document.getElementById("power-card-07-value");
            const chartDeviation = document.getElementById(
                "power-card-07-deviation"
            );
