...
const humidityCard05 = () => {
    const ctx = document.getElementById("humidity-card-05");
    if (!ctx) return;
    ...
    fetch("/json-humidity5")
        ...
        .then((result) => {
            ...
            const chartValue = document.getElementById(
                "humidity-card-05-value"
            );
            const chartDeviation = document.getElementById(
                "humidity-card-05-deviation"
            );
