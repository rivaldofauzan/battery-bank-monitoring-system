...
const currentCard02 = () => {
    const ctx = document.getElementById("current-card-02");
    if (!ctx) return;
    ...
    fetch("/json-current2")
        ...
        .then((result) => {
            ...
            const chartValue = document.getElementById("current-card-02-value");
            const chartDeviation = document.getElementById(
                "current-card-02-deviation"
            );
