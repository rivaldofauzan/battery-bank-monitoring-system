...
const currentCard07 = () => {
    const ctx = document.getElementById("current-card-07");
    if (!ctx) return;
    ...
    fetch("/json-current7")
        ...
        .then((result) => {
            ...
            const chartValue = document.getElementById("current-card-07-value");
            const chartDeviation = document.getElementById(
                "current-card-07-deviation"
            );
