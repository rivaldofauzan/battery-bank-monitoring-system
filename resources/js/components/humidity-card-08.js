...
const humidityCard08 = () => {
    const ctx = document.getElementById("humidity-card-08");
    if (!ctx) return;
    ...
    fetch("/json-humidity8")
        ...
        .then((result) => {
            ...
            const chartValue = document.getElementById(
                "humidity-card-08-value"
            );
            const chartDeviation = document.getElementById(
                "humidity-card-08-deviation"
            );
