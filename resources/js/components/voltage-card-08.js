...
const voltageCard08 = () => {
    const ctx = document.getElementById("voltage-card-08");
    if (!ctx) return;
    ...
    fetch("/json-voltage8")
        ...
        .then((result) => {
            ...
            const chartValue = document.getElementById("voltage-card-08-value");
            const chartDeviation = document.getElementById(
                "voltage-card-08-deviation"
            );
