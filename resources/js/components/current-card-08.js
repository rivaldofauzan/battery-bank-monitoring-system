...
const currentCard08 = () => {
    const ctx = document.getElementById("current-card-08");
    if (!ctx) return;
    ...
    fetch("/json-current8")
        ...
        .then((result) => {
            ...
            const chartValue = document.getElementById("current-card-08-value");
            const chartDeviation = document.getElementById(
                "current-card-08-deviation"
            );
