...
const voltageCard05 = () => {
    const ctx = document.getElementById("voltage-card-05");
    if (!ctx) return;
    ...
    fetch("/json-voltage5")
        ...
        .then((result) => {
            ...
            const chartValue = document.getElementById("voltage-card-05-value");
            const chartDeviation = document.getElementById(
                "voltage-card-05-deviation"
            );
