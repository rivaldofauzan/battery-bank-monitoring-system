...
const temperatureCard05 = () => {
    const ctx = document.getElementById("temperature-card-05");
    if (!ctx) return;
    ...
    fetch("/json-temperature5")
        ...
        .then((result) => {
            ...
            const chartValue = document.getElementById(
                "temperature-card-05-value"
            );
            const chartDeviation = document.getElementById(
                "temperature-card-05-deviation"
            );
...
export default temperatureCard05;
