...
const humidityCard02 = () => {
    const ctx = document.getElementById("humidity-card-02");
    if (!ctx) return;
    ...
    fetch("/json-humidity2")
        ...
        .then((result) => {
            ...
            const chartValue = document.getElementById(
                "humidity-card-02-value"
            );
            const chartDeviation = document.getElementById(
                "humidity-card-02-deviation"
            );
