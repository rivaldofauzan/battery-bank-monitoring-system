...
const humidityCard06 = () => {
    const ctx = document.getElementById("humidity-card-06");
    if (!ctx) return;
    ...
    fetch("/json-humidity6")
        ...
        .then((result) => {
            ...
            const chartValue = document.getElementById(
                "humidity-card-06-value"
            );
            const chartDeviation = document.getElementById(
                "humidity-card-06-deviation"
            );
