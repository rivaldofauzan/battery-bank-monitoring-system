...
const voltageCard04 = () => {
    const ctx = document.getElementById("voltage-card-04");
    if (!ctx) return;
    ...
    fetch("/json-voltage4")
        ...
        .then((result) => {
            ...
            const chartValue = document.getElementById("voltage-card-04-value");
            const chartDeviation = document.getElementById(
                "voltage-card-04-deviation"
            );
