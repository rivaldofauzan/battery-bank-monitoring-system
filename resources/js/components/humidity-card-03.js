...
const humidityCard03 = () => {
    const ctx = document.getElementById("humidity-card-03");
    if (!ctx) return;
    ...
    fetch("/json-humidity3")
        ...
        .then((result) => {
            ...
            const chartValue = document.getElementById(
                "humidity-card-03-value"
            );
            const chartDeviation = document.getElementById(
                "humidity-card-03-deviation"
            );
