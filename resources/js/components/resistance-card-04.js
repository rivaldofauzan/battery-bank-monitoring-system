...
const resistanceCard04 = () => {
    const ctx = document.getElementById("resistance-card-04");
    if (!ctx) return;
    ...
    fetch("/json-resistance4")
        ...
        .then((result) => {
            ...
            const chartValue = document.getElementById(
                "resistance-card-04-value"
            );
            const chartDeviation = document.getElementById(
                "resistance-card-04-deviation"
            );
...
export default resistanceCard04;
