...
const resistanceCard02 = () => {
    const ctx = document.getElementById("resistance-card-02");
    if (!ctx) return;
    ...
    fetch("/json-resistance2")
        ...
        .then((result) => {
            ...
            const chartValue = document.getElementById(
                "resistance-card-02-value"
            );
            const chartDeviation = document.getElementById(
                "resistance-card-02-deviation"
            );
...
export default resistanceCard02;
