...
const voltageCard06 = () => {
    const ctx = document.getElementById("voltage-card-06");
    if (!ctx) return;
    ...
    fetch("/json-voltage6")
        ...
        .then((result) => {
            ...
            const chartValue = document.getElementById("voltage-card-06-value");
            const chartDeviation = document.getElementById(
                "voltage-card-06-deviation"
            );
