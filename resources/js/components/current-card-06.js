...
const currentCard06 = () => {
    const ctx = document.getElementById("current-card-06");
    if (!ctx) return;
    ...
    fetch("/json-current6")
        ...
        .then((result) => {
            ...
            const chartValue = document.getElementById("current-card-06-value");
            const chartDeviation = document.getElementById(
                "current-card-06-deviation"
            );
