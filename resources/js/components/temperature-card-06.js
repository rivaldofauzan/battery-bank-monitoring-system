...
const temperatureCard06 = () => {
    const ctx = document.getElementById("temperature-card-06");
    if (!ctx) return;
    ...
    fetch("/json-temperature6")
        ...
        .then((result) => {
            ...
            const chartValue = document.getElementById(
                "temperature-card-06-value"
            );
            const chartDeviation = document.getElementById(
                "temperature-card-06-deviation"
            );
...
export default temperatureCard06;
